...
class _MedicalRecordState extends State<MedicalRecord> {
  ...
  final _addressController = TextEditingController(
    text: "Lapu-Lapu City, Cebu, Philippines",
  );
  final _contactController = TextEditingController(text: "0912-345-6789");
  final _emailController = TextEditingController(text: "v.rajime.v@gmail.com");
  final _diagnosisController = TextEditingController(
    text: "Eczema (skin inflammation)",
  );
  final _treatmentController = TextEditingController(
    text: "Topical cream and hydration",
  );
  final _notesController = TextEditingController(
    text: "Patient advised to avoid sun exposure.",
  );
  ...
  Widget _buildFixedDownloadButton() {
    return Container(
  ...
  Future<void> _downloadPdf() async {
    ...
    await Printing.sharePdf(
      ...
      filename: "${_lastNameController.text}_medical_record.pdf",
    );
  }
}
